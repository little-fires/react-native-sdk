...
- (void)backendSetSessionkey:(NSString * _Nonnull)sessionkey;
- (void)backendNotify:(NSString * _Nonnull)deviceId data:(NSString * _Nonnull)data onSuccess:(void (^ _Nonnull)(BOOL))onSuccess;
...
- (void)deviceSetAutoTimeSync:(NSString * _Nonnull)deviceUuid autoTimeSync:(BOOL)autoTimeSync;
- (void)deviceSetAutoNotify:(NSString * _Nonnull)deviceUuid autoNotify:(BOOL)autoNotify;
...
- (void)autoDeviceSetFilterByDeviceIds:(NSString * _Nonnull)deviceUuid filterByDeviceIds:(NSArray<NSString *> * _Nullable)filterByDeviceIds;
- (void)autoDeviceGetFilterByDeviceIds:(NSString * _Nonnull)deviceUuid;
...
- (void)measurementUnitConversionUtilsConvert:(double)value :(NSString * _Nonnull)src :(NSString * _Nonnull)dst;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

typedef SWIFT_ENUM(NSInteger, ErrorCode, open) {
  ErrorCodeInvalidDeviceId = 0,
  ErrorCodeInvalidDeviceUuid = 1,
  ErrorCodeInvalidAutoDevice = 2,
  ErrorCodeInvalidMeasurementUnit = 3,
};
...
/// Returns flag to indicate to auto execute time sync command with device if available
- (BOOL)getAutoTimeSync SWIFT_WARN_UNUSED_RESULT;
/// Returns flag to indicate to auto notify readings to cloud
- (BOOL)getAutoNotify SWIFT_WARN_UNUSED_RESULT;
...
/// Sets the flag to indicate to auto execute time sync command with device if available
/// \param autoTimeSync Flag to indicate to auto execute time sync command with device if available
///
- (void)setAutoTimeSync:(BOOL)autoTimeSync;
/// Sets the flag to indicate to auto notify readings to cloud
/// \param autoNotify Flag to indicate to auto notify readings to cloud
///
...
typedef SWIFT_ENUM(NSInteger, MeasurementUnit, open) {
  MeasurementUnitPercentage = 0,
  MeasurementUnitBeatsPerMinute = 1,
  MeasurementUnitMicrograms = 2,
  MeasurementUnitMilligrams = 3,
  MeasurementUnitGrams = 4,
  MeasurementUnitKilograms = 5,
  MeasurementUnitOunces = 6,
  MeasurementUnitPounds = 7,
  MeasurementUnitCentimeters = 8,
  MeasurementUnitMeters = 9,
  MeasurementUnitKilometers = 10,
  MeasurementUnitMiles = 11,
  MeasurementUnitInches = 12,
  MeasurementUnitFeet = 13,
  MeasurementUnitLiters = 14,
  MeasurementUnitMilliliters = 15,
  MeasurementUnitFluidOuncesUs = 16,
  MeasurementUnitMillimolesPerLiter = 17,
  MeasurementUnitMilligramsPerDeciliter = 18,
  MeasurementUnitMillimetersOfMercury = 19,
  MeasurementUnitWatts = 20,
  MeasurementUnitKilocaloriesPerDay = 21,
  MeasurementUnitCalories = 22,
  MeasurementUnitKilocalories = 23,
  MeasurementUnitJoules = 24,
  MeasurementUnitKilojoules = 25,
  MeasurementUnitCelsius = 26,
  MeasurementUnitFahrenheit = 27,
  MeasurementUnitMetersPerSecond = 28,
  MeasurementUnitKilometersPerHour = 29,
  MeasurementUnitMilesPerHour = 30,
};
